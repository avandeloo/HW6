...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="PlayerID" DataSourceID="SqlDataSource1" Width="280px" HeaderText="PLAYER DETAILS" CssClass="cssdetailsview">
            <Fields>
                ...
                <asp:CommandField ShowEditButton="True" ShowDeleteButton="True" DeleteText="DELETE" EditText="EDIT" UpdateText="UPDATE" />
            </Fields>
        </asp:DetailsView>
    </form>
</body>
